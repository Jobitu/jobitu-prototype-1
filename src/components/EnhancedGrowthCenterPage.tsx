...
export function EnhancedGrowthCenterPage({ 
  userData, 
  onBack, 
  activeTab = 'overview' 
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <Dialog open={showGoalDialog} onOpenChange={setShowGoalDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <Input placeholder="Enter your career goal..." value={careerGoal} onChange={(e) => setCareerGoal(e.target.value)} />
      ...
      {/* Plan Builder Dialog */}
      <Dialog open={showPlanBuilderDialog} onOpenChange={setShowPlanBuilderDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Build Your Personalized Learning Plan</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h4 className="font-medium text-blue-800 mb-2">AI Plan Generation</h4>
              <p className="text-sm text-blue-700 mb-3">
                We'll analyze your career goal, profile skills, CV data, and employer feedback to create a personalized plan.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span>Career Goal: {careerGoal}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span>Profile Skills: React, JavaScript, Node.js</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span>CV Analysis: Available</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span>Employer Feedback: 3 recent feedback items</span>
                </div>
              </div>
            </div>
            
            <div className="space-y-3">
              <h4 className="font-medium">Customize Your Focus Areas</h4>
              <div className="grid grid-cols-2 gap-2">
                {['System Design', 'Leadership', 'Database Optimization', 'Microservices', 'Team Management', 'AWS/Cloud'].map((skill) => (
                  <label key={skill} className="flex items-center space-x-2">
                    <Checkbox defaultChecked={['System Design', 'Leadership'].includes(skill)} />
            ...
            <div className="space-y-3">
              <h4 className="font-medium">Timeline Preference</h4>
              <Select defaultValue="12weeks">
                <SelectTrigger>
                  <SelectValue placeholder="Select timeline" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="4weeks">4 weeks (Intensive)</SelectItem>
                  <SelectItem value="8weeks">8 weeks (Balanced)</SelectItem>
                  <SelectItem value="12weeks">12 weeks (Comprehensive)</SelectItem>
                  <SelectItem value="16weeks">16 weeks (Extended)</SelectItem>
                </SelectContent>
              </Select>
            </div>
      ...
      {/* Mentor Packages Dialog */}
      <Dialog open={showMentorPackagesDialog} onOpenChange={setShowMentorPackagesDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Select Mentorship Package</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {selectedMentor && (
              <>
                  ...
                  {[
                    {
                      ...
                      duration: '60 min',
                      price: '$120',
                      description: 'Deep dive into system design principles and practice',
                      preparation: ['System Design Fundamentals reading', 'Practice problems']
                    },
                    {
                      ...
                      preparation: ['Career goals worksheet', 'Current resume review']
                    },
                    {
                      ...
                      preparation: ['Coding challenges review', 'Behavioral questions prep']
                    }
                  ].map((pkg, index) => (
                    <div key={index} className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-gray-700 mb-1">Pre-session preparation:</p>
                        <ul className="text-gray-600">
                          {pkg.preparation.map((item, idx) => (
                            <li key={idx}>• {item}</li>
                          ))}
                        </ul>
                      </div>
                ...
                <div className="mt-4">
                  <div className="flex items-center space-x-2 mb-3">
                    <Checkbox id="share-plan-packages" />
                    <label htmlFor="share-plan-packages" className="text-sm">
                      Share my career plan and learning progress with mentor
                    </label>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">{selectedResource.modules} modules</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline" className="text-xs capitalize">{selectedResource.difficulty}</Badge>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• Master advanced React patterns and architecture</li>
                    <li>• Understand state management best practices</li>
                    <li>• Build scalable component libraries</li>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['React Documentation Deep Dive', 'State Management Guide', 'Performance Patterns'].map((resource) => (
                      <Badge key={resource} variant="outline" className="text-xs cursor-pointer hover:bg-blue-50">
                        {resource}
                      </Badge>
                    ))}
                  </div>
      ...
      <Dialog open={showAssessmentDetailDialog} onOpenChange={setShowAssessmentDetailDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
          ...
          {selectedAssessment && (
            <div className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold mb-2">{selectedAssessment.title}</h3>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <Badge variant="outline" className="text-xs">{selectedAssessment.difficulty}</Badge>
                      </div>
                      <div className="flex justify-between">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Multiple Choice', 'System Design', 'Code Review', 'Architecture Diagrams'].map((type) => (
                ...
                <div className="mb-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                  ...
                  <ul className="text-sm text-yellow-700 space-y-1">
                    ...
                    <li>• Practice drawing architecture diagrams</li>
                    <li>• Study scalability patterns and trade-offs</li>
          ...
          <div className="space-y-4">
            {selectedMentor && (
              <>
                ...
                <Input type="time" />
                <div className="flex items-center space-x-2">
                  <Checkbox id="share-plan" />
                  <label htmlFor="share-plan" className="text-sm">
                    Share my career plan with mentor
                  </label>
                </div>
                <Button className="w-full">Book Session - {selectedMentor.price}</Button>
              </>
            )}
          </div>
        </DialogContent>
